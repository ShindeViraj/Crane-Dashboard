        ...
        <div class="login-card">
            <div class="login-logo">
                <div class="login-logo-icon" style="overflow:hidden;">
                    <img src="assets/logo.png" alt="Bajaj Mukand" style="width:48px;height:48px;object-fit:contain;">
                </div>
                <h1>BAJAJ MUKAND</h1>
            ...
            <div class="login-footer">
                ...
                <br><span style="margin-top:8px;display:inline-block;">Bajaj Mukand IoT Dashboard &copy; <?php echo date('Y'); ?></span>
            </div>
        </div>
    </div>
